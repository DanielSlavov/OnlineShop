<template>
  <div class="modal is-active">
    <div  v-on:click.stop="goBack" class="modal-background"></div>
    ...
    <button @click="goBack" class="modal-close is-large" aria-label="close"></button>
  </div>
</template>
      ...
      Login(){
          userService.login(this.email,this.password).then(res=>{
            router.back()
              ...
              //console.log(res.response.data) server error name
